...
//=============================================================================
/**
 * @file   modAOS_Macros.hpp
 * @author Tad Kollar  
 *
 * $Id: modAOS_Macros.hpp 2350 2013-09-03 14:29:09Z tkollar $
...
#ifndef _MOD_AOS_MACROS_HPP_
#define _MOD_AOS_MACROS_HPP_
...
//=============================================================================
/**
 * @class newAOSChannelProps
 * @author Tad Kollar  
 * @brief General settings for an entire AOS channel.
*/
//=============================================================================
class newAOSChannelProps {
public:
	size_t frameLength;
	size_t bitstreamSvcCount;
	size_t packetSvcCount;
	size_t vcAccessSvcCount;
	size_t vcFrameSvcCount;
	size_t mcFrameSvcCount;
	size_t insertZoneLength;
	...
	newAOSChannelProps(const xmlrpc_c::value_struct& settingsStruct);
 ...
 * @class modAOS_Macros
 * @author Tad Kollar  
 * @brief Methods for automatically creating AOS channels.
*/
//=============================================================================
class modAOS_Macros {
public:
	/// @brief Perform all steps to create a new AOS forward channel.
	/// @param channelName The identifier of the new physical channel.
	/// @param props General properties for the entire channel.
	void newForwardChannel(const std::string& channelName, const newAOSChannelProps& props) const;

	/// @brief Perform all steps to create a new AOS return channel.
	/// @param channelName The identifier of the new physical channel.
	/// @param props General properties for the entire channel.
	void newReturnChannel(const std::string& channelName, const newAOSChannelProps& props) const;
...
private:
	...
	Channel* _initializeAOSChannel(const std::string& channelName, const newAOSChannelProps& props) const;
	...
	/// @brief Create a settings group for an AOS Virtual Channel Generation segment.
	...
	/// @brief Create a settings group for an AOS Virtual Channel Reception segment.
	/// @param channel A reference to an existing channel.
	/// @param targetName The segment that the new one will output to.
	/// @param props The general properties for the entire channel.
	/// @param mcCount The current master channel count; to be used as the Spacecraft Identifier.

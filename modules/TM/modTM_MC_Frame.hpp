...
//=============================================================================
/**
 * @file   modTM_MC_Frame.hpp
 * @author Tad Kollar  
 *
 * $Id: modTM_MC_Frame.hpp 1604 2012-06-21 18:24:05Z tkollar $ 
 * Copyright (c) 2012.
...
#ifndef _MOD_TM_MC_FRAME_HPP_
#define _MOD_TM_MC_FRAME_HPP_
...
//=============================================================================
/**
 * @class modTM_MC_Frame
 * @author Tad Kollar  
 * @brief Wrap incoming TM Transfer Frame buffers with TM_Transfer_Frame objects.
 */
//=============================================================================
class modTM_MC_Frame: public TM_VirtualChannel_Service {
public:
	/// Primary constructor.
	/// @param newName An identifier for the module that's unique within the channel.
	/// @param newChannelName An identifier for the containing channel.
	/// @param newDLLPtr Pointer to the DLL management structure.
    modTM_MC_Frame(const std::string& newName, const std::string& newChannelName,
